        ...
        <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
          <div className="text-gray-500 sm:text-lg">
            ...
            <ul role="list" className="pt-8 space-y-5 border-t border-gray-200 my-7">
              ...
              <li className="flex space-x-3">
                <svg className="flex-s        <!-- Row -->
                <!-- List -->
                        <!-- Icon -->
                        <!-- Icon -->
                        <!-- Icon -->
hrink-0 w-5 h-5 text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
